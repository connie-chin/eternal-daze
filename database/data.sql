...
values
    ...
    ('1990s Polo Shirt', 25, 'this would be where the measurement info goes', 'images/IMG_whitePoloFront.JPG', 1),
        ('1980s Makeup Shirt', 45, 'this would be where the measurement info goes', 'images/IMG_makeupShirtFront.JPG', 1),
    ('1990s Crochet Top', 30, 'this would be where the measurement info goes', 'images/IMG_whiteCrochetShirtBack.JPG', 1),
    ('1970s Bear Shirt', 65, 'this would be where the measurement info goes', 'images/IMG_bearShirtFront.JPG', 1),
